      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center w-full">
        ...
        >
          <div className="relative mx-auto w-full max-w-4xl">
            <div className="absolute -inset-3 md:-inset-4 border border-gold/20 rounded-2xl pointer-events-none" />
            <div className="absolute -inset-6 md:-inset-8 border border-gold/10 rounded-3xl pointer-events-none" />

            <div className="relative z-10 w-full aspect-video rounded-xl overflow-hidden shadow-2xl shadow-charcoal/10 bg-black">
              <iframe
